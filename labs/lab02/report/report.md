...
![Сайт github.com](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.1.jpg){#fig:001 width=70%}
...
![Ввод имени владельца](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.2.jpg){#fig:002 width=70%}


Ввели следующие команды, указав email владельца репозитории (рис. 4.3 Ввод команды почты владельца).

![Ввод команды почты владельца](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.3.jpg){#fig:003 width=70%}


3. Настроим utf-8 в выводе сообщений git (рис. 4.4 Настройка utf-8 в выводе сообщений git).

![Настройка utf-8 в выводе сообщений git](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.4.jpg){#fig:004 width=70%}


4. Задали имя начальной ветки (рис. 4.5 Имя начальной ветки).

![Имя начальной ветки](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.5.jpg){#fig:005 width=70%}


5. Настроили autocrlf (рис. 4.6 Параметр autocrlf).

![Параметр autocrlf](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.6.jpg){#fig:006 width=70%}


6. Настроили safecrlf (рис. 4.7 Параметр safecrlf).

![Параметр safecrlf](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.7.jpg){#fig:007 width=70%}
...
![Копирование ключа](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.9.jpg){#fig:009 width=70%}

8. Внесли ключ на сайте (рис. 4.9 Ключ).

![Ключ](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.10.jpg){#fig:010 width=70%}

9. Создали каталог для предмета «Архитектура компьютера» (рис. 4.10 Создание каталога «Архитектура компьютера»).

![Создание каталога «Архитектура компьютера»](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.11.jpg){#fig:011 width=70%}

10. Создали репозиторий через сайт github (рис. 4.11 Создание репозитория).

![Создание репозитория](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.12.jpg){#fig:012 width=70%}

11. Перешли в каталог курса (рис. 4.12 Переход в каталог).

![Переход в каталог](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.13.jpg){#fig:013 width=70%}

12. Клонировали репозиторий (рис. 4.13 Клонирование репозитория).

![Клонирование репозитория](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.14.jpg){#fig:014 width=70%}


13. Удалили лишние файлы (рис. 4.14 Ввод команды для удаления).

![Ввод команды для удаления](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.16.jpg){#fig:016 width=70%}

14. Создали каталоги (рис. 4.15 Ввод команды для создания каталогов).

![Ввод команды для создания каталогов](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.17.jpg){#fig:017 width=70%}

15. Отправили файлы на сервер (рис. 4.16 Отправка данных на сервер).

![Отправка данных на сервер](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.18.jpg){#fig:018 width=70%}
...
![Проверка правильности создания рабочего пространства](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.21.jpg){#fig:021 width=70%}

Задание для самостоятельной работы

1. Создали каталог для внесения отчета по выполнению лабораторной работы в (labs>lab02>report) (рис. 4.18 Создание каталога).

![Создание каталога](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.22.jpg){#fig:022 width=70%}
...
![Загрузка файлов на github](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.24.jpg){#fig:024 width=70%}

![Проверка файлов на github](/home/nmeliseykina/work/study/2024-2025/Архитектура компьютера/study_2024-2025_arhpc/labs/lab02/report/image/4.25.jpg){#fig:025 width=70%}
